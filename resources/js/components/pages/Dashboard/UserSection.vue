        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card user_card shadow-lg">
                    ...
                    <div class="user_card-body d-flex align-items-center justify-content-between">
                        <div class="user_info">
                            ...
                            <h5 class="user_card-title">John Doe</h5>
                            <p class="user_card-text"><strong>Email:</strong> johndoe@example.com</p>
                            <p class="user_card-text"><strong>Phone:</strong> +1234567890</p>
                        ...
                        <div class="user_buttons text-end">
                            <div class="d-grid gap-2">
                                ...
                                <button class="btn btn-danger user_btn" type="button">Logout</button>
                            </div>
                        </div>
                    </div>
                </div>
...
.user_card-header {
    background-color: #0056b3; /* Darker primary color for header */
    color: white;
...
.user_avatar {
    width: 100px; /* Fixed size for user avatar */
    height: 100px;
    border: 4px solid #007bff; /* Border for avatar */
